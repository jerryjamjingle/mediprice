...
{selectedHospital && (
  ...
  <a href={`https://www.healthgrades.com/search?what=${encodeURIComponent(selectedHospital.hospitalName)}&where=St.+Louis`} target="_blank" rel="noopener noreferrer" className="contact-link">⭐ Healthgrades</a>
</div>
