    ...
    <div className="about-page">
      ...
      <div className="about-content">
        ...
        <div className="about-body">
          ...
          <p className="highlight">MedExpense changes that.</p>
          ...
          <p>MedExpense is for the 30 million uninsured Americans, the millions more with high deductibles, and anyone who's ever gotten a medical bill and thought — <em>why didn't anyone tell me this beforehand?</em></p>

          <p className="highlight">We believe healthcare pricing should be as easy to compare as flights or hotels.</p>

          <p><strong>MedExpense is how we get there.</strong></p>
        </div>
